...
Last reviewed: 2026-06-18 (admin roster: reliable role edits via admin_set_member_role RPC, member delete via admin_delete_member, search/sort, nickname display; fixed coverage matrix emptied by selecting non-existent profiles.email)
